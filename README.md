...
- **Интерактивный TUI** — полноэкранный режим просмотра с запуском через mpv / vlc / буфер обмена
...
**Способы воспроизведения:** mpv · vlc · скопировать ссылку в буфер обмена
